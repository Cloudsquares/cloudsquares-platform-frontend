...
// --- Icons ---
import { CornerDownLeftIcon } from "@/modules/TipTapEditorModule/components/tiptap-icons/corner-down-left-icon";
import { ExternalLinkIcon } from "@/modules/TipTapEditorModule/components/tiptap-icons/external-link-icon";
...
// --- Tiptap UI ---
import type { UseLinkPopoverConfig } from "@/modules/TipTapEditorModule/components/tiptap-ui/link-popover";
import { useLinkPopover } from "@/modules/TipTapEditorModule/components/tiptap-ui/link-popover";
...
import {
  Input,
  InputGroup,
} from "@/modules/TipTapEditorModule/components/tiptap-ui-primitive/input";
  ...
  ({ className, children, ...props }, ref) => {
    ...
    return (
      <Button
        ...
        role="button"
        tabIndex={-1}
        aria-label={t("tipTapEditor.toolbar.link")}
      ...
      >
        <CardItemGroup orientation="horizontal">
          <InputGroup>
            <Input
              type="url"
              placeholder={t("tipTapEditor.toolbar.linkPlaceholder")}
              value={url}
          ...
          <ButtonGroup orientation="horizontal">
            <Button
              type="button"
              onClick={setLink}
              title={t("tipTapEditor.toolbar.linkApply")}
          ...
          <ButtonGroup orientation="horizontal">
            <Button
              type="button"
              onClick={openLink}
              title={t("tipTapEditor.toolbar.linkOpenInNewTab")}
              disabled={!url && !isActive}
              data-style="ghost"
            >
            ...
            <Button
              type="button"
              onClick={removeLink}
              title={t("tipTapEditor.toolbar.linkDelete")}
              disabled={!url && !isActive}
              data-style="ghost"
            >
